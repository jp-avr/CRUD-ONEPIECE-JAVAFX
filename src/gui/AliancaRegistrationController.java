...
public class AliancaRegistrationController implements Initializable, DataChangeListener{
    ...
    @FXML
    private TableColumn<Alianca, Alianca> TableColumnREMOVE;
    ...
    private void initRemoveButtons() {
        ...
        TableColumnREMOVE.setCellFactory(param -> new TableCell<Alianca, Alianca>() {
    ...
    private void removeEntity(Alianca obj) {
