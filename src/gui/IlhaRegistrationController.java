...
public class IlhaRegistrationController implements Initializable, DataChangeListener{
    ...
    @FXML
    private TableColumn<Ilha, Ilha> TableColumnEDIT;

    @FXML
    private TableColumn<Ilha, Ilha> TableColumnREMOVE;
    ...
    private void initEditButtons() {
        ...
        TableColumnEDIT.setCellFactory(param -> new TableCell<Ilha, Ilha>() {
            private final Button button = new Button("Editar");

            @Override
            protected void updateItem(Ilha obj, boolean empty) {
                ...
                setGraphic(button);
                button.setOnAction(
                    event -> createDialogForm(obj, "/gui/IlhaForm.fxml", Utils.currentStage(event)));
            }           
        });
    }
    ...
    private void initRemoveButtons() {
        ...
        TableColumnREMOVE.setCellFactory(param -> new TableCell<Ilha, Ilha>() {
    ...
    private void removeEntity(Ilha obj) {
